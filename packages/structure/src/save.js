...
(function() {
  ...
  out$.prepareSvg = function(el, options, done) {
    ...
    return inlineImages(el).then(function() {
      ...
      var _ref4 = options || {},
        ...
        backgroundColor =
          _ref4$backgroundColor === undefined
            ? "transparent"
      ...
      return inlineCss(el, options).then(function(css) {
        ...
        else return { src: src, width: width, height: height };
      });
    });
  };
  ...
  out$.svgAsDataUri = function(el, options, done) {
    ...
    var result = out$.prepareSvg(el, options).then(function(_ref5) {
      var src = _ref5.src;
      var b64 = b64EncodeUnicode(doctype + src);
      return (
  ...
  out$.svgAsPngUri = function(el, options, done) {
    ...
    var _ref6 = options || {},
      ...
      encoderType =
        _ref6$encoderType === undefined ? "image/png" : _ref6$encoderType,
      _ref6$encoderOptions = _ref6.encoderOptions,
      encoderOptions =
        _ref6$encoderOptions === undefined ? 0.8 : _ref6$encoderOptions,
      canvg = _ref6.canvg;
    ...
    if (navigator.msSaveOrOpenBlob)
      ...
      if ("download" in saveLink) {
        ...
        try {
          ...
          console.warn(
            "This browser does not support object URLs. Falling back to string URL."
          );
          saveLink.href = uri;
        }
        saveLink.click();
  ...
  out$.b64EncodeUnicode = b64EncodeUnicode;
  out$.b64DecodeUnicode = b64DecodeUnicode;
